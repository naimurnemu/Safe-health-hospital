        ...
        <div className="col">
          <div className="border rounded">
            ...
            <div className="card-body">
              ...
              <h3 className="text-warning"><i class="fas fa-phone-alt"></i> For Call <u>+8237897432873</u> </h3>
        ...
        <div className="col">
          <div className="border rounded">
            ...
            <div className="card-body">
              ...
              <h3 className="text-warning"><i class="fas fa-phone-alt"></i> For Call <u>+8233878347893</u> </h3>
